        ...
        if e.position == "Director":
            ...
            while True:
                ...
                # hire new employee
                    ...
                    print(
                        f"Congratulations! You have 1 new {position}, {age} y o {name}")
                    db.hospital.view_employee_records()
                ...
                # fire bad employee
                    ...
                    # call fire_employee()
                    print(
                        f"Bye, {db.hospital.employees_records[fire_id].name}! You're fired!")
                    db.hospital.fire_employee(
                        db.hospital.employees_records[fire_id])
                ...
                # admit new patient
                    ...
                    print(
                        f"Patient {name}, {age} y o, {blood_type} blood type has been admitted.")
                    db.hospital.view_patient_records()
            ...
            while True:
                ...
                # exit program
                elif doc_response == "4" or doc_response == "Exit":
                    break
            ...
            while True:
                ...
                if jan_response == "1" or jan_response == "Work report":
                    print(f"Keep up the good work, {e.username}!")
